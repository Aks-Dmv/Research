...
from sac.modules import *
from sac.sac import *
from sac.sac_agent import *
from sac.gail import *
...
parser.add_argument('--prediction-steps', type=int, default=6, metavar='N',
...
# optimizer = optim.Adam(list(encoder.parameters()) + list(decoder.ac.parameters()),
#                        lr=args.lr)
...
algorithm = AdvSMM(
    ...
    policy_optim_batch_size=75*args.batch_size,
    num_edges=args.edge_types,
    disc_optim_batch_size=75*args.batch_size)
